...
const ForceWebScreen: React.FC = () => {
  ...
  const title = i18n.t("force_web_title");
  const subtitle = i18n.t("force_web_subtitle");
  const buttonText = i18n.t("force_web_button");
        ...
        <View style={styles.glassCard}>
          ...
          >
            ...
            >
              ...
              <Feather name="external-link" size={18} color="#2A1154" style={styles.buttonIcon} />
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </View>
