...
import { ExamResult, Question, StudentQuestionResult, TextbookResult } from '@/utils/types'
...
const Vulnerable: FC<Props> = ({ data, keyOpen, openProblem, isPrint, changeOpen, isMyStoryStudent }) => {
  ...
  }, [JSON.stringify(data.studentQuestionResults)])
  ...
  const renderTableRow = (item: StudentQuestionResult, index: number, dataLength: number) => (
  ...
  const renderQuestionItem = (question: StudentQuestionResult) => (
