...
type Props = {
  ...
  onStart: (type: AlarmType, duration: number, subject?: SubjectTimerResponse) => void
}

const useAlarmTextbook = ({ onStart, handleCloseDialog }: Props) => {
  ...
  const handleStartAudio = async (textbook: Textbook) => {
    onStart(AlarmType.Subject, textbook.duration, textbook.subject as any)
  }
